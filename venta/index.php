<?php // venta/index.php — Propiedades en venta
...
$where = ["p.activa = 1", "p.tipo_operacion = 'venta'"];
$params = [];
...
$pageTitle = $ciudadName ? "Propiedades en venta en $ciudadName" : 'Propiedades en venta';
$pageDesc = "Explora " . $total . " propiedades en venta" . ($ciudadName ? " en $ciudadName" : '') . ". Compra tu hogar ideal con CP Real Agent.";
$canonicalUrl = SITE_URL . '/venta/' . ($ciudadSlug ? $ciudadSlug . '/' : '');
...
<section class="py-20 bg-accent text-white" style="background: linear-gradient(135deg, #1A252F 0%, #2C3E50 100%);">
    <div class="max-w-4xl mx-auto px-4 text-center">
        <span class="inline-block px-3 py-1 bg-blue-500/20 text-blue-300 text-sm font-medium rounded-full mb-4">💰 Venta</span>
...
<section class="py-10 bg-white">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <?= render_pagination($page, $total, PROPERTIES_PER_PAGE, '/venta/' . ($ciudadSlug ? $ciudadSlug . '/' : '')) ?>
        <?php else: ?>
        <div class="text-center py-20">
            <h3 class="text-xl font-bold text-gray-400 mb-2">No hay propiedades en venta<?= $ciudadName ? " en $ciudadName" : '' ?> por el momento</h3>
